      ...
      <section className="py-24 bg-black relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            <Button 
              size="lg" 
              className="bg-neon-cyan text-black hover:bg-neon-cyan/80 font-bold text-lg px-8 py-6 h-auto rounded-full shadow-[0_0_20px_rgba(0,240,255,0.3)] hover:shadow-[0_0_40px_rgba(0,240,255,0.5)] transition-all"
            >
              AGENDAR ATENDIMENTO VIA PORTAL DO ALUNO <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
