    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <Badge variant="outline" className="border-red-600 text-red-600 mb-6 px-4 py-1">MBA OFICIAL FABRANI</Badge>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 border-l-4 border-red-500 pl-6 py-2">
                {mba.target}
              </p>
            </div>
            <div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-4">
            {mba.modules.map((module: string, i: number) => (
              <div key={i} className="group p-6 border border-white/10 bg-black hover:border-red-500/50 transition-all rounded-lg flex items-center gap-6">
                <div className="text-4xl font-bold text-white/10 group-hover:text-red-500/20 transition-colors">
                  0{i + 1}
                </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1" className="border-white/10">
              <AccordionTrigger className="text-lg hover:text-red-500">Preciso saber programar?</AccordionTrigger>
            ...
            <AccordionItem value="item-2" className="border-white/10">
              <AccordionTrigger className="text-lg hover:text-red-500">Como medimos o ROI?</AccordionTrigger>
              <AccordionContent className="text-gray-400 text-base">
            ...
            <AccordionItem value="item-3" className="border-white/10">
              <AccordionTrigger className="text-lg hover:text-red-500">O conteúdo é atualizado?</AccordionTrigger>
              <AccordionContent className="text-gray-400 text-base">
