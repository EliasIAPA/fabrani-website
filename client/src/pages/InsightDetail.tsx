    ...
    <div className="min-h-screen bg-black text-white pt-20 overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 py-12 grid md:grid-cols-[1fr_300px] gap-12">
        <article className="prose prose-invert prose-lg max-w-none">
          <div className="bg-zinc-900/50 border-l-4 border-red-500 p-6 mb-10 rounded-r-lg">
        ...
        <aside className="space-y-8">
          <div className="bg-zinc-900/30 border border-white/5 rounded-xl p-6 sticky top-24">
            <h4 className="font-bold text-lg mb-4 flex items-center gap-2">
              <Download className="w-5 h-5 text-red-600" /> Downloads
            </h4>
            ...
            <div className="mt-8 pt-8 border-t border-white/10">
              <h4 className="font-bold text-lg mb-4 flex items-center gap-2">
                <Share2 className="w-5 h-5 text-red-500" /> Compartilhar
              </h4>
              <div className="flex gap-2">
                <Button variant="outline" size="icon" className="rounded-full border-white/10 hover:bg-white/10 hover:text-red-500">
