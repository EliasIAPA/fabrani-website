...
const mbas = [
  {
    ...
    icon: <Briefcase className="w-10 h-10 text-neon-cyan" />,
  ...
  },
  {
    ...
    icon: <Stethoscope className="w-10 h-10 text-neon-purple" />,
  ...
  },
  {
    ...
    icon: <Megaphone className="w-10 h-10 text-neon-cyan" />,
  ...
  },
  {
    ...
    icon: <Target className="w-10 h-10 text-neon-purple" />,
    ...
    <div className="min-h-screen bg-black text-white pt-24 pb-20">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto mb-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <Badge variant="outline" className="border-neon-cyan text-neon-cyan mb-4 px-4 py-1">FORMAÇÃO EXECUTIVA</Badge>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-6">
            MBAs de Aplicação <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan to-neon-purple">Prática</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {mbas.map((mba, index) => (
            <Card key={mba.id} className="bg-white/5 border-white/10 hover:border-neon-cyan/50 transition-all duration-300 group overflow-hidden">
              <CardHeader>
                <div className="mb-4 bg-black/50 w-16 h-16 flex items-center justify-center rounded-full border border-white/10 group-hover:border-neon-cyan/50 transition-colors">
                  {mba.icon}
                </div>
              ...
              <CardFooter>
                <Link href={`/mbas/${mba.id}`} className="w-full">
                  <Button className="w-full bg-white text-black hover:bg-neon-cyan hover:text-black font-bold transition-all">
