  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-neon-cyan/30">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-neon-purple/10 via-background to-background z-0"></div>
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neon-purple/10 border border-neon-purple/20 text-neon-purple text-sm font-mono mb-4">
              <BrainCircuit className="w-4 h-4" />
              <span>COMISSÃO PRÓPRIA DE AVALIAÇÃO</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tighter leading-tight">
              CPA FABRANI: A INTELIGÊNCIA QUE <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan to-neon-purple">AUDITA NOSSA EXCELÊNCIA</span>
            </h1>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[300px] rounded-2xl overflow-hidden border border-white/10 bg-black/50 flex items-center justify-center group">
              <div className="absolute inset-0 bg-gradient-to-br from-neon-cyan/20 to-neon-purple/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <BrainCircuit className="w-32 h-32 text-white/10 group-hover:text-neon-cyan/50 transition-colors duration-500" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={index} className="bg-black/40 border-white/10 hover:border-neon-cyan/50 transition-all duration-300 group">
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    <span className="text-4xl font-bold text-white/5 group-hover:text-neon-cyan/20 transition-colors">{item.step}</span>
                    <item.icon className="w-6 h-6 text-neon-purple group-hover:text-neon-cyan transition-colors" />
                  </div>
                  <CardTitle className="text-xl group-hover:text-neon-cyan transition-colors">{item.title}</CardTitle>
                </CardHeader>
                <CardContent>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="space-y-4 text-center">
                <div className="w-12 h-12 mx-auto rounded-full bg-neon-cyan/10 flex items-center justify-center border border-neon-cyan/20">
                  <span className="font-mono text-neon-cyan font-bold">{index + 1}</span>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-black/40 border border-white/10 rounded-2xl p-8">
              ...
              <ul className="space-y-2 text-sm font-mono text-white/70 mb-8">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-neon-cyan"></div>Docentes</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-neon-cyan"></div>Discentes</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-neon-cyan"></div>Corpo Técnico-Administrativo</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-neon-cyan"></div>Sociedade Civil</li>
              </ul>
        ...
        <div className="container text-center max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-left">
            {[
              ...
              <div key={index} className="flex items-center gap-3 p-4 rounded-lg bg-black/40 border border-white/10 hover:border-neon-cyan/30 transition-colors cursor-pointer group">
                <FileText className="w-8 h-8 text-white/20 group-hover:text-neon-cyan transition-colors" />
                <div>
                  <p className="text-sm font-medium group-hover:text-neon-cyan transition-colors">{doc}</p>
          ...
          <div className="mt-16 pt-8 border-t border-white/10">
            ...
            <a href="mailto:cpa@fabrani.com.br" className="inline-flex items-center gap-2 text-neon-cyan hover:underline">
