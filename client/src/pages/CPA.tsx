    ...
    <div className="overflow-x-hidden min-h-screen bg-background text-foreground selection:bg-red-500/30">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://d2xsxph8kpxj0f.cloudfront.net/310419663030990044/CVhAjXry9cXgYyqVqtTxQF/ia-cpa-avaliacao-red-k7RL4NrhCf2f6ScyBWL7Aa.webp" alt="" className="w-full h-full object-cover opacity-20" />
        </div>
        <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-background/90 to-background z-0"></div>
