...
export default function ComoSerParceiro() {
  return (
    <div className="flex flex-col gap-0 min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-20 text-center max-w-4xl">
          <div className="mb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-6 leading-[0.9]">
              Como Ser <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan via-white to-neon-purple drop-shadow-[0_0_15px_rgba(0,240,255,0.3)]">
                Parceiro FABRANI
              </span>
            </h1>
            ...
            <a href="mailto:contato@fabrani.com.br">
              <Button 
                size="lg" 
                className="bg-neon-cyan text-black hover:bg-neon-cyan/80 font-bold text-lg px-10 py-8 rounded-none shadow-[0_0_20px_rgba(0,240,255,0.3)] hover:shadow-[0_0_40px_rgba(0,240,255,0.5)] transition-all transform hover:-translate-y-1"
              >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-8">
              Credenciamento Oficial no <span className="text-neon-cyan">MEC</span>
            </h2>
            ...
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              ...
              <div className="bg-white/5 border border-neon-cyan/20 rounded-lg p-8 mt-8">
                <h3 className="text-2xl font-bold text-white mb-6">Informações de Credenciamento</h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-neon-cyan flex-shrink-0 mt-1" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-12">
              Transforme Seu Curso em <span className="text-neon-purple">Extensão Universitária</span> Reconhecida
            </h2>
            ...
            <div className="space-y-4 mb-12">
              {[
                ...
                <div key={idx} className="flex items-start gap-4 p-6 bg-gradient-to-r from-neon-cyan/10 to-neon-purple/10 rounded-lg border border-neon-cyan/20">
                  <div className="text-2xl font-bold text-neon-cyan flex-shrink-0">{idx + 1}</div>
                  <div>
      ...
      <section className="py-24 bg-black relative overflow-hidden border-b border-white/5">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-full bg-neon-purple/5 blur-[100px] pointer-events-none"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-12">
              Como Funciona a <span className="text-neon-cyan">Parceria</span>
            </h2>
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={idx} className="flex gap-6 p-8 bg-white/5 rounded-lg border border-white/10 hover:border-neon-cyan/30 transition-colors">
      ...
      <section className="py-24 bg-secondary/5 border-b border-white/5">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-12">
              Validade Jurídica da <span className="text-neon-purple">Certificação</span>
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={idx} className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-neon-cyan flex-shrink-0 mt-1" />
                      <span className="text-lg">{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="bg-gradient-to-br from-neon-cyan/10 to-neon-purple/10 border border-neon-cyan/20 rounded-lg p-8">
      ...
      <section className="py-24 bg-black relative overflow-hidden border-b border-white/5">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-12">
              Por Que Escolher a <span className="text-neon-cyan">FABRANI</span>
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="flex items-start gap-4 p-6 bg-white/5 rounded-lg border border-white/10 hover:border-neon-cyan/30 transition-colors">
                  <CheckCircle2 className="w-6 h-6 text-neon-cyan flex-shrink-0 mt-1" />
                  <span className="text-lg">{item}</span>
                </div>
              ))}
      ...
      <section className="py-24 bg-secondary/5 border-b border-white/5">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-12">
              Para Quem é Esta <span className="text-neon-purple">Parceria</span>
            </h2>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="flex items-start gap-4 p-6 bg-gradient-to-r from-neon-purple/10 to-neon-cyan/10 rounded-lg border border-neon-purple/20">
                  <div className="text-2xl font-bold text-neon-purple flex-shrink-0">✓</div>
                  <span className="text-lg">{item}</span>
                </div>
              ))}
            </div>
      ...
      <section className="py-24 bg-black relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-neon-cyan/10 to-transparent pointer-events-none"></div>
        <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <a href="https://wa.me/5516997117597" target="_blank" rel="noopener noreferrer">
                <Button 
                  size="lg" 
                  variant="outline"
                  className="border-neon-purple text-neon-purple hover:bg-neon-purple/10 font-bold text-lg px-10 py-8 rounded-none"
                >
