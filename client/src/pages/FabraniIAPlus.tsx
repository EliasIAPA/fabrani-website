  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-4 relative z-20 text-center max-w-6xl">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-neon-cyan/30 bg-neon-cyan/5 text-neon-cyan text-xs font-mono mb-8 backdrop-blur-md"
          >
          ...
          >
            FABRANI <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan via-white to-neon-purple drop-shadow-[0_0_30px_rgba(0,240,255,0.4)]">IA+</span>
          </motion.h1>
          ...
          >
            ...
            Dois treinamentos de elite. <span className="text-neon-cyan font-bold">100% Custeados pela FABRANI.</span>
          </motion.p>
          ...
          >
            <Button 
              size="lg" 
              className="bg-neon-cyan text-black hover:bg-neon-cyan/80 font-bold text-lg px-12 py-8 rounded-none w-full sm:w-auto shadow-[0_0_20px_rgba(0,240,255,0.3)] hover:shadow-[0_0_40px_rgba(0,240,255,0.5)] transition-all transform hover:-translate-y-1"
            >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tighter mb-6">
              DUPLA <span className="text-neon-purple">CERTIFICAÇÃO</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <motion.div 
              whileHover={{ y: -10 }}
              className="group relative bg-zinc-900/50 border border-white/10 rounded-2xl overflow-hidden hover:border-neon-cyan/50 transition-all duration-500"
            >
              <div className="absolute inset-0 bg-gradient-to-b from-neon-cyan/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6">
                  <Badge className="bg-neon-cyan text-black hover:bg-neon-cyan mb-3 border-none">FUNDAMENTOS APLICADOS</Badge>
                  <h3 className="text-3xl font-bold text-white group-hover:text-neon-cyan transition-colors">Letramento em IA</h3>
                </div>
              </div>
            ...
            <motion.div 
              whileHover={{ y: -10 }}
              className="group relative bg-zinc-900/50 border border-white/10 rounded-2xl overflow-hidden hover:border-neon-purple/50 transition-all duration-500"
            >
              <div className="absolute inset-0 bg-gradient-to-b from-neon-purple/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/50 to-transparent"></div>
                <div className="absolute bottom-6 left-6">
                  <Badge className="bg-neon-purple text-white hover:bg-neon-purple mb-3 border-none">GESTÃO E ESTRATÉGIA</Badge>
                  <h3 className="text-3xl font-bold text-white group-hover:text-neon-purple transition-colors">Engenharia de Prompt</h3>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <Button variant="outline" className="border-neon-cyan text-neon-cyan hover:bg-neon-cyan hover:text-black mt-4">
          ...
          <div className="relative border-l-2 border-white/10 ml-4 md:ml-0 space-y-12 md:space-y-0">
            {[
              ...
              <div key={index} className={`md:flex items-center justify-between gap-8 group ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
                ...
                <div className="absolute left-[-9px] md:left-1/2 md:-translate-x-1/2 w-5 h-5 rounded-full bg-black border-2 border-neon-cyan group-hover:bg-neon-cyan transition-colors z-10"></div>
                
                <div className="md:w-5/12 pl-8 md:pl-0">
                  <div className={`p-6 rounded-xl bg-zinc-900/30 border border-white/5 hover:border-neon-cyan/30 transition-all ${index % 2 === 0 ? 'md:text-right' : ''}`}>
      ...
      <section className="py-32 relative overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-r from-neon-cyan/20 to-neon-purple/20 blur-3xl opacity-30"></div>
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            ...
            <span className="text-neon-cyan font-bold">Investimento Zero. Retorno Infinito.</span>
          </p>
          <Button 
            size="lg" 
