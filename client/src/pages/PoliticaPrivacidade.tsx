    ...
    <div className="min-h-screen bg-black text-white pt-24 pb-16 overflow-x-hidden">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-12 text-center">
          <div className="inline-flex items-center justify-center p-3 bg-red-600/10 rounded-full mb-6 border border-red-600/20">
        ...
        <div className="space-y-12 text-gray-300 leading-relaxed">
          ...
          <section className="bg-white/5 p-8 rounded-2xl border border-white/10 backdrop-blur-sm">
            <p className="mb-4">
              A <span className="text-red-500 font-bold">FABRANI</span>, mantenedora do site <span className="font-mono">www.fabrani.com.br</span>, valoriza a privacidade e a proteção de dados pessoais. Esta Política descreve como coletamos, utilizamos, compartilhamos e protegemos dados de visitantes, alunos e parceiros.
            </p>
            <p>
              Ao utilizar nossos sites e serviços, você concorda com os termos desta Política, que deve ser lida em conjunto com nossos <span className="text-white font-medium">Termos de Uso</span> e <Link href="/politica-cookies" className="text-red-500 hover:underline">Política de Cookies</Link>.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              <span className="bg-red-500/20 text-red-500 w-8 h-8 rounded-lg flex items-center justify-center text-sm font-mono">01</span>
              Quem somos e papéis LGPD
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="bg-black/50 p-6 rounded-xl border border-white/10">
                <h3 className="font-bold text-white mb-2 flex items-center gap-2">
                  <Database className="w-4 h-4 text-red-500" /> Controladora
                </h3>
              ...
              <div className="bg-black/50 p-6 rounded-xl border border-white/10">
                <h3 className="font-bold text-white mb-2 flex items-center gap-2">
                  <UserCheck className="w-4 h-4 text-red-600" /> Encarregado (DPO)
                </h3>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              <span className="bg-red-500/20 text-red-500 w-8 h-8 rounded-lg flex items-center justify-center text-sm font-mono">02</span>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-start gap-4 p-4 border-l-2 border-white/10 hover:border-red-500 hover:bg-white/5 transition-all">
                  <div>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              <span className="bg-red-500/20 text-red-500 w-8 h-8 rounded-lg flex items-center justify-center text-sm font-mono">03</span>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              <span className="bg-red-500/20 text-red-500 w-8 h-8 rounded-lg flex items-center justify-center text-sm font-mono">04</span>
          ...
          {/* 5. Segurança */}
          <section className="bg-gradient-to-r from-red-500/5 to-transparent p-6 rounded-xl border-l-4 border-red-500">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <Lock className="w-5 h-5 text-red-500" /> Segurança da Informação
            </h2>
            ...
            <div className="flex items-center gap-2 text-xs text-red-500 font-mono uppercase tracking-wider">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              <span className="bg-red-500/20 text-red-500 w-8 h-8 rounded-lg flex items-center justify-center text-sm font-mono">06</span>
              Seus Direitos (LGPD)
            </h2>
